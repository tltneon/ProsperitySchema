...
if ( CLIENT ) then
	...
	SWEP.VElements = {
		["weapon"] = { type = "Model", model = "models/props_interiors/Furniture_Lamp01a.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(-0.456, -0.456, 5.908), angle = Angle(-181.024, 13.295, -8), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
	SWEP.WElements = {
		["weapon"] = { type = "Model", model = "models/props_interiors/Furniture_Lamp01a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.181, 1.363, -2.274), angle = Angle(0, -180, -9.205), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
