...
if ( CLIENT ) then
	...
	SWEP.VElements = {
		["weapon"] = { type = "Model", model = "models/props_c17/signpole001.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(-0.456, -0.456, 5.908), angle = Angle(-1.024, 13.295, -8), size = Vector(1, 1, .5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
	SWEP.WElements = {
		["weapon"] = { type = "Model", model = "models/props_c17/signpole001.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.181, 1.363, 4), angle = Angle(0, -180, -180), size = Vector(1, 1, .5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
