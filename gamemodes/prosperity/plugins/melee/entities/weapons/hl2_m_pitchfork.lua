...
if ( CLIENT ) then
	...
	SWEP.VElements = {
		["weapon"] = { type = "Model", model = "models/warz/melee/pitchfork.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(0, 0.455, 1.363), angle = Angle(1, 13, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
	SWEP.WElements = {
		["weapon"] = { type = "Model", model = "models/warz/melee/pitchfork.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1, -10), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
