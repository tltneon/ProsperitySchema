...
if( CLIENT ) then
	SWEP.PrintName = "Chitin Short Bow"
	SWEP.Slot = 0
	SWEP.SlotPos = 1
	SWEP.DrawAmmo = true
...
SWEP.ViewModel      = "models/morrowind/chitin/shortbow/v_chitin_shortbow.mdl"
SWEP.WorldModel   = "models/morrowind/chitin/shortbow/w_chitin_shortbow.mdl"
