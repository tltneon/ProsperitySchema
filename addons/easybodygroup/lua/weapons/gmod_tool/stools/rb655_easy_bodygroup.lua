...
language.Add( "tool.rb655_easy_bodygroup.0", "Select entity by left or right clicking on it, or press reload to select yourself" )
...
function TOOL.BuildCPanel( panel, ent )
	...
	Presets:SetPreset( "rb655_easy_bodygroup_" .. ent:GetModel() )
	Presets:AddConVar( "rb655_easy_bodygroup_skin" )
	for i = 0, MaxBodyGroups do Presets:AddConVar( "rb655_easy_bodygroup_group" .. i ) end
