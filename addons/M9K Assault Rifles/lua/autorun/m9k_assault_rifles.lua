...
if SERVER then
	...
	if ( file.Exists( "lua/autorun/m9k_assault.lua", "GAME" ) ) then
		timer.Simple(3, function()
			print("It looks like you have the new and old Murderthon 9000 Assault Rifles addons installed. To prevent errors, you should delete the old addon. Not sure which to delete? Delete both of them, and Garrys Mod will automatically download the right addon next time you load the game. Sorry for the trouble!")
			PrintMessage(HUD_PRINTTALK, "It looks like you have the new and old Murderthon 9000 Assault Rifles addons installed. To prevent errors, you should delete the old addon." )
		end)
