...
SWEP.Gun = ("m9k_horrorpython") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Horror Python"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= Sound("horror/alert_far1.wav")		-- Script that calls the primary fire sound
