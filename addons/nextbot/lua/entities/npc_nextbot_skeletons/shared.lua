...
ENT.WalkAnim = (ACT_HL2MP_WALK_ZOMBIE_04)
...
ENT.Attack2 = Sound("npc/bonemesh/attack.mp3")
...
function ENT:Initialize()
	...
	local skin = math.random(1,4)
		if skin == 1 then self:SetSkin( 1 ) else
		if skin == 2 then self:SetSkin( 2 ) end
		if skin == 3 then self:SetSkin( 3 ) end
		if skin == 4 then self:SetSkin( 0 ) end
	end
