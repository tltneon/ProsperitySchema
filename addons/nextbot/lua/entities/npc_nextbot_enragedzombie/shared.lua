...
function ENT:IdleSounds()
	if SERVER then
	self:EmitSound("npc/infected_zombies/been_shot_"..math.random(16)..".wav", math.random(75,95), math.random(65,70))
	end
end

function ENT:AlertSound()
	if SERVER then
	self:EmitSound("npc/infected_zombies/rage_at_victim"..math.random(32,37)..".wav", math.random(75,95), math.random(65,70))
	end
end
...
function ENT:Attack()
    ...
    self.nxtAttack = CurTime() + 1.2
		...
		self:EmitSound("npc/infected_zombies/rage_at_victim"..math.random(20,31)..".wav", math.random(75,95), math.random(60,75))
...
function ENT:OnKilled( dmginfo )
	local zombie = ents.Create("rage_deathanim")
			if !self:IsValid() then return end
