...
ENT.Items = { "item_healthvial", "item_box_buckshot", "item_ammo_357" }
...
--Model Settings--
ENT.Model = "models/Zombie/rebelzombie.mdl"
...
ENT.WalkAnim3 = (ACT_HL2MP_WALK_ZOMBIE_04)
...
function ENT:Initialize()
	...
	self.Anims = { self.WalkAnim1, self.WalkAnim2, self.WalkAnim3, self.WalkAnim4 }
...
function ENT:OnKilled( dmginfo )
	...
	ammo:SetPos(self:GetPos() + Vector(0,0,20)) 
	ammo:Spawn() 
	...
	local phys = ammo:GetPhysicsObject()
			if phys:IsValid() then
				...
				phys:SetVelocityInstantaneous(ang:Forward() * math.Rand(325, 690))
	end
