...
function ENT:OnTakeDamage(dmg)
   if math.random(1,3) == 1 then
		...
		self:EmitSound( "ambient/wind/wind_moan1.wav",450,math.random(80,120))
		return
   end
   ...
   if math.random(4) == 1 then
	...
	self:EmitSound( self.hurt1,450,math.random(80,120))
	elseif sound_seed == 2 then
	self:EmitSound( self.hurt2,450,math.random(80,120))
	elseif sound_seed == 3 then
	self:EmitSound( self.hurt3,450,math.random(80,120))
	end	
   end
...
function ENT:FindEnemyDan()
	...
	for k,v in pairs(MyNearbyTargets) do
		...
		if self.Alerted == false then
			if randomsound == 1 then
	      		self:EmitSound( self.alert1,450,math.random(80,120))
			elseif randomsound == 2 then
	      		self:EmitSound( self.alert2,450,math.random(80,120))
			elseif randomsound == 3 then
	      		self:EmitSound( self.alert3,450,math.random(80,120))
			end
		end
		self.Alerted = true
	      	return
...
function ENT:KilledDan()
	...
	if     deathseed == 1 then
	  self:EmitSound( self.die1,450,math.random(80,120))
	elseif deathseed == 2 then
	  self:EmitSound( self.die2,450,math.random(80,120))
	elseif deathseed == 3 then
	  self:EmitSound( self.die3,450,math.random(80,120))
	end
