...
resource.AddFile("models/glowstick/v_glowstick_rng.mdl")
resource.AddFile("models/glowstick/stick_rng.mdl")
resource.AddFile("materials/models/glowstick/glow_rng.vtf")
...
if ( CLIENT ) then
  ...
  language.Add ("ent_glowstick_fly", "Glow Stick Orange")
  	SWEP.DrawAmmo			= false
