...
resource.AddFile("models/glowstick/v_glowstick_blu.mdl")
resource.AddFile("models/glowstick/stick_blu.mdl")
resource.AddFile("materials/models/glowstick/glow_blu.vtf")
...
if ( CLIENT ) then
  ...
  language.Add ("ent_glowstick_fly", "Glow Stick Blue")
  	SWEP.DrawAmmo			= false
...
SWEP.ViewModel			= "models/glowstick/v_glowstick_blu.mdl"
SWEP.WorldModel			= "models/glowstick/stick_blu.mdl"
...
function SWEP:PrimaryAttack()
	...
	self:TakePrimaryAmmo(1)
		...
		self.Owner:SetAnimation( PLAYER_ATTACK1 )
				if SERVER then
					local ent = ents.Create("ent_glowstick_blu_fly")
