...
resource.AddFile("models/glowstick/v_glowstick_lblu.mdl")
resource.AddFile("models/glowstick/stick_lblu.mdl")
resource.AddFile("materials/models/glowstick/glow_lblu.vtf")
...
if ( CLIENT ) then
  ...
  language.Add ("ent_glowstick_lblu_fly", "Glow Stick Blue")
	SWEP.DrawAmmo			= false
	...
	SWEP.HoldType			= "slam"	
	SWEP.PrintName			= "Glow Stick Light Blue"			
...
function SWEP:PrimaryAttack()
	...
	self:TakePrimaryAmmo(1)
		...
		self.Owner:SetAnimation( PLAYER_ATTACK1 )
				if SERVER then
					local ent = ents.Create("ent_glowstick_lblu_fly")
