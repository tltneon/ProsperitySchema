...
resource.AddFile("models/glowstick/v_glowstick_red.mdl")
resource.AddFile("models/glowstick/stick_red.mdl")
resource.AddFile("materials/models/glowstick/glow_red.vtf")
resource.AddFile("materials/models/glowstick/01.vtf")
resource.AddFile("sound/glowstick/draw.wav")
...
if ( CLIENT ) then
  ...
  language.Add ("ent_glowstick_fly", "Glow Stick Red")
  	SWEP.DrawAmmo			= false
...
SWEP.ViewModel			= "models/glowstick/v_glowstick_red.mdl"
SWEP.WorldModel			= "models/glowstick/stick_red.mdl"
...
function SWEP:PrimaryAttack()
	...
	self:TakePrimaryAmmo(1)
		...
		self.Owner:SetAnimation( PLAYER_ATTACK1 )
				if SERVER then
					local ent = ents.Create("ent_glowstick_red_fly")
