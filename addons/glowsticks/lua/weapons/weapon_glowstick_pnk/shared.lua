...
resource.AddFile("models/glowstick/v_glowstick_pnk.mdl")
resource.AddFile("models/glowstick/stick_pnk.mdl")
resource.AddFile("materials/models/glowstick/glow_pnk.vtf")
...
if ( CLIENT ) then
  ...
  language.Add ("ent_glowstick_fly", "Glow Stick Pink")
  	SWEP.DrawAmmo			= false
...
SWEP.ViewModel			= "models/glowstick/v_glowstick_pnk.mdl"
SWEP.WorldModel			= "models/glowstick/stick_pnk.mdl"
