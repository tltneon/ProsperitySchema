...
if GetConVar("M9KDefaultClip") == nil then
	CreateConVar("M9KDefaultClip", "2", { FCVAR_REPLICATED, FCVAR_NOTIFY, FCVAR_ARCHIVE }, "How many clips will a weapon spawn with? Negative reverts to default values.")
	print("Default Clip con var created")
end

if GetConVar("M9KIncludeRcon") == nil then
	CreateConVar("M9KIncludeRcon", "1", { FCVAR_REPLICATED, FCVAR_ARCHIVE }, "Include \"rcon\" when copying console commands to clipboard?")
end
