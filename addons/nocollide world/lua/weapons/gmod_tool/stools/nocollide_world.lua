		...
		for i=1,#EFFECT.Draw do
			if EFFECT.Draw[i] then
				...
				elseif EFFECT.Draw[i][3] == 9 then
					effects.halo.Add({EFFECT.Draw[i][4]}, Color(255, 255, 255, 255), 10, 10, 1)
				elseif EFFECT.Draw[i][3] == 10 then
					effects.halo.Add({EFFECT.Draw[i][4]}, Color(255, 150, 50, 255), 10, 10, 1)
				elseif EFFECT.Draw[i][3] == 11 then
					effects.halo.Add({EFFECT.Draw[i][4]}, Color(100, 255, 100, 255), 10, 10, 1)
				end
			end
		end
	end
